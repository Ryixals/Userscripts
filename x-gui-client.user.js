...
(() => {
    ...
    let latestProcess = -1;
    const cheat = (async () => {
        const versionName = "8.00x";
        const byName = " by Ryixals";
...
.creditsPage>ul>li>span{color:var(--textColor2);font-weight:800}.creditsPage>ul>li i{margin-inline:2px;line-height:1}.creditsPage a{color:var(--highlight);text-decoration:none}.creditsPage a:hover,.pathPage:hover{text-decoration:underline}.warning{color:var(--highlight2);font-size:.85em}.searchResult{cursor:pointer}.searchResultName{font-weight:800}.searchResultDescription{font-size:.8em}.searchResultSeparator{font-size:1.5em;font-weight:800;margin-block:10px;cursor:pointer;transition:.2s;border-bottom:2px solid #fff;padding-inline:5px;filter:drop-shadow(0px 0px 0px var(--highlight))}.searchResultSeparator:hover{color:var(--highlight);border-bottom:2px solid var(--highlight);filter:drop-shadow(0px 0px 2.5px var(--highlight))}.toggleCheat{--buttonColor:var(--toggleOff)}.toggleCheat.active{--buttonColor:var(--toggleOn)}.logMessage img{height:1em;align-self:center}.standing{display:flex;font-weight:800;align-items:center;position:relative;padding:5px 10px 5px 50px;border-radius:2.5px;background:var(--highlight2)}.standing:before{content:attr(data-place) ".";margin-right:10px}.standing::after{content:attr(data-value);flex:1;text-align:right;font-weight:100}.standing:hover{background:var(--standingColor);box-shadow:0 0 7.5px var(--standingColor)}.standingBlook{height:1.25em;align-self:center;position:absolute;left:10px}.favoriteButton,.favoriteButton>i{transition:.2s;display:grid;place-items:center;width:32px;height:32px}.favoriteButton{font-size:.8em;padding-left:5px;cursor:pointer}.favoriteButton:hover{color:#ff0}.favoriteButton>i{position:absolute;scale:0;transform-origin:50% 55%}.favoriteButton>i.filled{scale:1}.pathPage{cursor:pointer;color:var(--highlight)}[data-favorited=false],[data-favorites="0"]{display:none}
        ...
        version.innerText = "X-GUI " + versionName + byName;
...
`;
            ...
            extras: {
                ...
                cheats: [{
                        name: "EXECUTOR",
                        description: "Opens an advanced, sleek, GUI with countless features, made by Ryixals",
                        run: function() {
                            try {
    ...
    `;
            ...
            gold: {
                ...
                cheats: [{
                        name: "Always Double",
                        description: "Always get double gold",
                        type: "toggle",
                        enabled: false,
                        data: {
                            type: "multiply",
                    ...
                    },
                    {
                        ...
                        name: "Always Quadruple",
                        description: "Always get quadruple gold",
                        type: "toggle",
                        enabled: !1,
                        data: null,
                        run: function() {
                        ...
                        name: "Always God Gold",
                        description: "Always get God Gold",
                        type: "toggle",
                        enabled: false,
                        data: null,
                        run: function() {
                            const num = Math.floor(Math.random() * (1000000000 - 1000000 + 1)) + 1000000;
                            let e = Object.values(document.querySelector("body div[id] > div > div"))[1].children[0]._owner.stateNode;
                            e._choosePrize ||= e.choosePrize,
                                this.enabled ? (this.enabled = !1, clearInterval(this.data), this.data = null, e.choosePrize = e._choosePrize || e.choosePrize) : (this.enabled = !0, this.data = setInterval(() => {
                                    e.choosePrize = function(t) {
...
`;
            ...
            dino: {
                img: "https://media.blooket.com/image/upload/v1663212881/Media/logos/Deceptive_Dinos_Logo_Resized.png", //https://media.blooket.com/image/upload/wyaci6d9idtpkd34rmzy
            ...
            royale: {
                img: "https://media.blooket.com/image/upload/v1663212881/Media/logos/Battle_Royale_Logo_Resized.png", //https://media.blooket.com/image/upload/p1yibtlelaucmdzsxvey
                name: "Battle Royale",
                cheats: [{
            ...
            racing: {
                img: "https://media.blooket.com/image/upload/v1663212882/Media/logos/Racing_Logo_Resized.png", //https://media.blooket.com/image/upload/x0eee9nbyo22exi7p3qd
                name: "Racing",
                cheats: [{
                        name: "Instant Win",
            ...
            rush: {
                img: "https://media.blooket.com/image/upload/v1663212881/Media/logos/Blook_Rush_Logo_Resized.png", //https://media.blooket.com/image/upload/oa9gwebaop7hxdrmee1y
                name: "Blook Rush",
                cheats: [{
                        name: "Set Blooks",
            ...
            gamemode.onclick = async () => {
                ...
                if (unsupportedModes.includes(mode)) {
                    ...
                    createNoticeOverlay(cheatsPage, {
                        svgPath: LOCK_SVG,
                        title: "Not Supported",
                        message: "Cheats for this gamemode are still in development.",
                        buttonHtml: {
                            href: "https://play.blooket.com/play",
                            target: "_self",
                            innerHTML: `<span style="margin-left:8px">I understand</span>`
                        },
                        buttonStyle: NOTICE_BTN_BASE,
                        onEnter: NOTICE_BTN_ENTER,
                        onLeave: NOTICE_BTN_LEAVE,
...
`;
        ...
        const versions = [
            ["Version 8.00x", "Added 11 new commands", "null"],
            ["Version 7.40x", "Fixed 3 bugs"],
            ["Version 7.30x", "Added 3 new commands", "null"],
            ["Version 7.20x", "Added 2 new commands", "null"],
            ["Version 7.10x", "Redesigned 3 architectures", "null"],
            ["Version 6.70x", "Redesigned 1 architecture", "null"],
            ["Version 6.69x", "Redesigned 5 architecture", "null"],
            ["Version 6.68x", "Added 1 new command", "null"],
            ["Version 6.67x", "Added 5 new commands", "null"],
            ["Version 6.66x", "Added 8 new commands", "null"],
            ["Version 6.65x", "Added 2 new commands", "null"],
            ["Version 6.64x", "Fixed 9 bugs", "null"],
            ["Version 6.63x", "Added 4 new comamnds", "null"],
            ["Version 6.62x", "Added 1 new command", "null"],
            ["Version 6.61x", "Added 2 new commands", "null"],
            ["Version 6.60x", "Changed 7 things", "null"],
            ["Version 6.50x", "Changed 2 things", "null"],
            ["Version 6.40x", "Added 1 new command", "null"],
            ["Version 6.30x", "Added 4 new commands", "null"],
            ["Version 6.20x", "Added 3 new commmands", "null"],
            ["Version 6.10x", "Added 1 new command", "null"],
            ["Version 6.00x", "Added 7 new commands", "null"],
            ["Version 5.90x", "Changed 3 things", "null"],
            ["Version 5.80x", "Updated 6 commands", "null"],
            ["Version 5.70x", "Added 3 new command", "null"],
            ["Version 5.60x", "Fixed 16 bugs", "null"],
            ["Version 5.50x", "Fixed 5 bugs", "null"],
            ["Version 5.40x", "Update 2 commands", "null"],
            ["Version 5.30x", "Updated 3 commands", "null"],
            ["Version 5.20x", "Added 2 new commands", "null"],
            ["Version 5.10x", "Added 3 new commands", "null"],
            ["Version 5.00x", "Added 1 new command", "null"],
            ["Version 4.90x", "Added 2 new commands", "null"],
            ["Version 4.80x", "Added 1 new command", "null"],
            ["Version 4.70x", "Fixed 4 spelling errors", "null"],
            ["Version 4.60x", "Added 2 new commands", "null"],
            ["Version 4.50x", "Fixed 8 bugs", "null"],
            ["Version 4.40x", "Fixed 2 bugs", "null"],
            ["Version 4.30x", "Fixed 2 spelling errors", "null"],
            ["Version 4.20x", "Added 1 new cheat", "null"],
            ["Version 4.10x", "Fixed 12 bugs", "null"],
            ["Version 4.00x", "Fixed 5 bugs", "null"],
            ["Version 3.90x", "Fixed 3 spelling errors", "null"],
            ["Version 3.80x", "Fixed 8 bugs", "null"],
            ["Version 3.70x", "Added 3 new commands", "null"],
            ["Version 3.60x", "Fixed 2 bugs", "null"],
            ["Version 3.50x", "Fixed 1 bug", "null"],
            ["Version 3.40x", "Added 2 new commands", "null"],
            ["Version 3.30x", "Fixed 5 bugs", "null"],
            ["Version 3.20x", "Added 3 new commands", "null"],
            ["Version 3.10x", "Added 7 new commands", "null"],
            ["Version 3.00x", "Fixed 2 bugs", "null"],
            ["Version 2.90x", "Added 1 new command", "null"],
            ["Version 2.80x", "Added 3 new commands", "null"],
            ["Version 2.70x", "Added a welcome message", "null"],
            ["Version 2.60x", "Added a glow effect", "null"],
            ["Version 2.50x", "Revamped the UI", "null"],
            ["Version 2.40x", "Changed the color scheme", "null"],
            ["Version 2.30x", "Fixed some commands", "null"],
            ["Version 2.20x", "Fixed 9 bugs", "null"],
            ["Version 2.10x", "Created a new menu", "null"]
        ];
...
`;
        ...
        copyrightTag.innerText = `Copyright © ${new Date().getFullYear()} Ryixals`;
