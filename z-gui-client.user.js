...
(() => {
    ...
    card.innerHTML = `
      <div style="margin:-18px -20px 14px -20px;padding:10px 14px;border-radius:14px 14px 0 0;border-bottom:1px solid rgba(255,255,255,.18);background:linear-gradient(125deg, rgba(255, 74, 74, 0.24), rgba(56, 16, 16, 0.9));display:flex;align-items:center;justify-content:space-between;gap:10px;">
        <div style="display:flex;align-items:center;gap:10px;">
          <div style="font-size:13px;font-weight:800;letter-spacing:.06em;text-transform:uppercase;">Z-GUI CLIENT</div>
      ...
      <div style="font-size:24px;font-weight:800;margin-bottom:10px;"><b>Z-GUI CLIENT</b></div>
      <div style="font-size:15px;opacity:.92;margin-bottom:14px;">Welcome to <b>Z-GUI</b>: a modern hack Gimkit.<br><br><b>Left-click</b> to enable/disable a module.<br><b>Right-click</b> to configure a modules settings.<br><b>'\\'</b> to hide/show the client.</div>
    `;
  ...
  style.textContent = `
    ...
    .zyrox-brand { display: flex; align-items: center; gap: 12px; color: var(--zyx-text-strong); white-space: nowrap; }
    ...
    .zyrox-brand .title { font-size: 12px; font-weight: 700; line-height: 1; }
        ...
        <div class="zyrox-settings-body">
          ...
          <div class="zyrox-setting-card">
            <div class="zyrox-about-content">
              <div><b>Z-GUI CLIENT</b>, formerly known as Zyrox Client (pre-v1.5.x) is a hack for Gimkit with module toggles, keybinds, and theming controls.</div>
