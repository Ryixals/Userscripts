...
(() => {
  ...
  const ACCENT = "#ff3b3b";
  const ACCENT_DIM = "rgba(255,59,59,0.15)";
  const ACCENT_SOFT = "rgba(255,59,59,0.1)";
  const ACCENT_VERY_SOFT = "rgba(255,59,59,0.04)";
  const ACCENT_BORDER = "rgba(255,59,59,0.5)";
  const ACCENT_HOVER = "rgba(255,59,59,0.18)";
  const ACCENT_TEXT = "rgba(255,59,59,0.5)";
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      #zyrox-resize-handle:hover, #zyrox-resize-handle.dragging { background: ${ACCENT_HOVER}; }
      #zyrox-header { position: relative; display:flex; align-items:center; gap:8px; padding: 12px 16px 12px 20px; background: ${ACCENT_VERY_SOFT}; border-bottom: 1px solid rgba(255,59,59,0.12); flex-shrink:0; }
      #zyrox-title { color:${ACCENT}; font-weight:700; font-size:18px; letter-spacing:0.1em; text-transform:uppercase; flex:1; }
      #zyrox-count { color: ${ACCENT_TEXT}; font-size: 12px; }
      ...
      .zyrox-toolbar-btn.active { border-color: ${ACCENT_BORDER}; color:${ACCENT}; background: ${ACCENT_SOFT}; }
      ...
      .zyrox-packet.active { border-left:2px solid rgba(255,59,59,0.6); padding-left:8px; }
      ...
      .zyrox-tab.active { color:${ACCENT}; border-bottom-color:${ACCENT}; }
      ...
      #zyrox-list, .zyrox-view-pane, #zyrox-resend-editor {
        ...
        scrollbar-color: rgba(255,59,59,0.55) rgba(0,0,0,0.8);
      }
      ...
      #zyrox-list::-webkit-scrollbar-thumb, .zyrox-view-pane::-webkit-scrollbar-thumb, #zyrox-resend-editor::-webkit-scrollbar-thumb {
        background: linear-gradient(180deg, rgba(255,59,59,0.7), rgba(190,0,0,0.7));
        border-radius: 6px;
      ...
      #zyrox-list::-webkit-scrollbar-thumb:hover, .zyrox-view-pane::-webkit-scrollbar-thumb:hover, #zyrox-resend-editor::-webkit-scrollbar-thumb:hover {
        background: linear-gradient(180deg, rgba(255,59,59,0.95), rgba(220,0,0,0.95));
      }
